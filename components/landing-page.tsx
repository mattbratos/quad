...
export function LandingPage() {
  return (
    <main className="flex-1">
      ...
      <section
        className="w-full py-12 md:py-24 lg:py-32 border-t border-b"
        id="features"
      >
        <div className="container px-4 md:px-6">
                ...
                <li>
                  <div className="grid gap-1">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      Quad's clean and modern design focuses on the essentials,
                      making it easy to use and navigate.
                    </p>
                  </div>
                </li>
                <li>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 border-t" id="cta">
